...
public class QuerySelfSubject1Action extends ActionSupport {
	...
	public String execute() throws Exception {
		...
		String author = request.getSession().getAttribute("id").toString();
		PageResult pageResult = subject1Service.querySelfSubject1ByAuthor(page,author);
		List<Subject1> subject1s = pageResult.getList();//获得试题记录
