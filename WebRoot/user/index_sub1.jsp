...
<body class="body">
		<table width="80%" border="0" align="center" cellpadding="0" cellspacing="10">
			<!--文章开始-->
				...
				<tr>
					<td align="right"><h2><font color="#0000ff">作者：${subject1.author}</h2></td>
				</tr>	
				<tr>
					<td align="right"><h3><font color="#250cad">${subject1.subject1_time}<br></h3></td>
				</tr>	
				</s:iterator>
				<!--文章结束-->			
		</table>
