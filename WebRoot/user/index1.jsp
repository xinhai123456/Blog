...
<div id="container">
	...
	<div id="globallink">
		<ul>
			...
			<li><a href="subject1Add.jsp" target="OfficeMain">发表文章</a></li>
			<li><a href="self_subject1Query.action" target="OfficeMain">个人文章管理</a></li>
		</ul>
		<ul>
			<li><a href="userCountManagement.jsp" target="_top">密码修改</a></li>
